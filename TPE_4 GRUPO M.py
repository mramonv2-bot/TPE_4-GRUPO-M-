...
class SimuladorContextoRealUNEMI:
    def __init__(self, root):
        ...
        self.root.configure(bg="#0d0e12") # Fondo ultra oscuro (Gris espacial profundo)
        
        # --- BASE DE DATOS DE CONTEXTO REAL ---
        ...
        # --- DISEÑO DE LA MALLA PRINCIPAL (LAYOUT COMPLEJO) ---
        self.root.columnconfigure(0, weight=1)
        self.root.rowconfigure(1, weight=1) # El cuerpo central se expande verticalmente

        # ==========================================
        # 1. ENCABEZADO SUPERIOR (CONTROL CENTRALIZADO)
        # ==========================================
        ...
        # Información del docente a la derecha
        ...
        # ==========================================
        # 2. CUERPO PRINCIPAL (DIVIDIDO EN PANELES)
        # ==========================================
        body_frame = tk.Frame(root, bg="#0d0e12", padx=15, pady=10)
        body_frame.grid(row=1, column=0, sticky="nsew")
        
        # Definición de columnas: Lateral Izquierdo (Controles), Centro-Izquierda (Gráficos), Derecha (Consola)
        body_frame.columnconfigure(0, weight=1)  # Panel de Configuración y Autores
        body_frame.columnconfigure(1, weight=3)  # Visualizador de Ondas
        body_frame.columnconfigure(2, weight=2)  # Monitor de Procesos
        body_frame.rowconfigure(0, weight=1)

        # ------------------------------------------
        # PANEL PANEL 1: CONFIGURACIÓN Y CRÉDITOS (IZQUIERDA)
        # ------------------------------------------
        left_panel = tk.Frame(body_frame, bg="#161920", bd=1, relief=tk.SOLID, padx=15, pady=15)
        left_panel.grid(row=0, column=0, sticky="nsew", padx=5, pady=5)
        
        # Subpanel de Control de Entrada
        ...
        # ------------------------------------------
        # PANEL PANEL 2: OSCILOSCOPIO / GRÁFICOS (CENTRO)
        # ------------------------------------------
        ...
        # Configuración avanzada de las figuras Matplotlib
        ...
        # ------------------------------------------
        # PANEL PANEL 3: MONITOR DE PROCESOS / CONSOLA (DERECHA)
        # ------------------------------------------
        ...
        # Configurar tags de color para la consola profesional
